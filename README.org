...
- [[file:+lang/pythonp][pythonp]]: Work with Python in a style similar to [[http:ess.r-project.org][ESS]] and other additions/improvements for the ~python~ layer of Spacemacs
