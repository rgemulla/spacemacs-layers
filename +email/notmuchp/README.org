...
- Append or insert e-mail addresses and sender/recipients using [[https://github.com/abo-abo/swiper][ivy]] or [[https://github.com/minad/consult][consult]] (via =,i=)
...
|                        | =,ii=       | Append/insert e-mail address                                                                                        |
|                        | =,iI=       | Append/insert e-mail addresses                                                                                      |
|                        | =,if=       | Change sender                                                                                                       |
|                        | =,it=       | Add TO recipient                                                                                                    |
|                        | =,ic=       | Add CC recipient                                                                                                    |
|                        | =,ib=       | Add BCC recipient                                                                                                   |
